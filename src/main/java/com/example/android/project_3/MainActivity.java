    ...
    * and wrong choices are not selected being 1 & 4 */
    ...
    private void displayScore() {
        ...
        if (score == numQuestions) {
            msg = res.getString(R.string.toast_correct,name.getText().toString());
            Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        } else if (score == 0) {
            msg = res.getString(R.string.toast_wrong,name.getText().toString());
            Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        } else {
            msg = res.getString(R.string.toast_score,name.getText().toString(),score,numQuestions);
